//
//  SmoothPath.cpp
//  PathSimplificationSample
//
//  Created by Greg Kepler on 5/22/12.
...
void SmoothPath::init(Vec2f startPt) {
    startIndex = 0;
    endIndex = 0;
    addPoint(startPt);
}
...
void SmoothPath::complete()
{
    ...
    if(mPoints.size() > 1) convertSmoothPath();
    inProgress = false;
}
...
void SmoothPath::convertSmoothPath()
{
